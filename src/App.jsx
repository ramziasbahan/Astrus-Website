      ...
      <main>
        ...
        <section id="contact" style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="section-container" style={{
            ...
            <div>
              <LogoBlock />
              <p style={{ fontSize: 16, lineHeight: 1.8, color: BRAND.navy, marginTop: 20 }}>
                Astrus Insurance Services provides clear, dependable insurance guidance for individuals, families, and businesses seeking protection they can trust. We believe insurance should feel reassuring, not exhausting — practical advice, responsive service, and solutions tailored to real-life needs.
              </p>
            </div>

            {/* Column 2: Contact card */}
            <div className="card" style={{ padding: 28 }}>
              <div style={{ fontWeight: 800, fontSize: 18, color: BRAND.ink, marginBottom: 20 }}>Contact us</div>
              ...
              <a href="tel:+9619211011" style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14, fontSize: 15, color: BRAND.navy }}>
                <Phone size={18} style={{ flexShrink: 0 }} />
                +961 9 211 011
              </a>

              <a href={'mailto:' + COMPANY_EMAIL} style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14, fontSize: 15, color: BRAND.navy }}>
                <Mail size={18} style={{ flexShrink: 0 }} />
                {COMPANY_EMAIL}
              </a>

              <a href="https://wa.me/9613252879" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 12, fontSize: 15, color: '#25D366' }}>
